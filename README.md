...
<summary>Example</summary>
  <img src="https://github.com/1zumiSagiri/mcx/blob/v0.4.1/docs/images/quick_start_example.png" alt="Quick Start Example" width="600px" />
</details>
...
See [`tests/example.typ`](https://github.com/1zumiSagiri/mcx/blob/v0.4.1/tests/example.typ) for a complete example.
